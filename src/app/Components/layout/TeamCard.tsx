  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-5">
        <h3 className="text-xl xl:text-2xl text-c-blue-900 font-semibold leading-6 mb-2.5 font-plus-jakarta-sans">
          {name}
        </h3>
      ...
      <div className="flex flex-wrap items-center justify-center space-x-4">
        ...
        <ul
          ref={leftIconsRef}
          className="flex items-center opacity-0 translate-x-5"
        >
        ...
        <span
          ref={buttonRef}
          className="relative opacity-100 w-8 h-8 mx-1.5 flex items-center justify-center rounded-full bg-slate-800 text-c-blue-900"
        >
